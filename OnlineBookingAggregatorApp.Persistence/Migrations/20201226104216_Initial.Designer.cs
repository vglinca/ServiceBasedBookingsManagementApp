...
namespace OnlineBookingAggregatorApp.Persistence.Migrations
{
    ...
    [Migration("20201226104216_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Entities.Company.Company", b =>
                {
                    ...
                    b.Property<long>("FirstRankClientType")
                        .HasColumnName("FirstRankClientTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FirstRankClientType");
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Entities.Lookup.FirstRankClientTypeEntity", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnName("FirstRankClientTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("FirstRankClientTypes");
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Entities.Company.Company", b =>
                {
                    b.HasOne("OnlineBookingAggregatorApp.Domain.Entities.Lookup.FirstRankClientTypeEntity", null)
                        .WithMany()
                        .HasForeignKey("FirstRankClientType")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
