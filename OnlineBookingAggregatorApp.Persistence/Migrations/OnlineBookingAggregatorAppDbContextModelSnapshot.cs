...
namespace OnlineBookingAggregatorApp.Persistence.Migrations
{
    ...
    partial class OnlineBookingAggregatorAppDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Entities.WeekDayWorkSchedule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("WeekDayWorkScheduleId")
                        .UseIdentityByDefaultColumn();
                    ...
                    b.ToTable("WeekDayWorkSchedules");
                });
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Enums.BookingStateEntity", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("BookingStateId");
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Enums.ColourEntity", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("ColourId");
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Enums.PolicyEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6L,
                            Name = "EditUnrelatedBookings",
                            ParentId = 0L
                        },
                        new
                        {
                            Id = 7L,
                            Name = "DeleteUnrelatedBookings",
                            ParentId = 0L
                        },
                        new
                        {
                            Id = 8L,
                            Name = "CreateUnrelatedBookings",
                            ParentId = 0L
                        },
                        new
                        {
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Enums.WeekDayEntity", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("WeekDayId");
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("OnlineBookingAggregatorApp.Domain.Enums.ColourEntity", null)
                        .WithMany()
                        .HasForeignKey("Colour");
                    ...
                    b.HasOne("OnlineBookingAggregatorApp.Domain.Enums.BookingStateEntity", null)
                        .WithMany()
                        .HasForeignKey("State")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineBookingAggregatorApp.Domain.Entities.WeekDayWorkSchedule", b =>
                {
                    ...
                    b.HasOne("OnlineBookingAggregatorApp.Domain.Enums.WeekDayEntity", null)
                        .WithMany()
                    ...
                    b.HasOne("OnlineBookingAggregatorApp.Domain.Entities.WorkSchedule", "WorkSchedule")
                        .WithMany()
